...
#define __XLINK_VERSION__       24002
...
typedef struct XLINK_CALLBACK_FUN {
	...
	//unsigned char ProductTestMode; //是否启用产测功能
	//char *ProductServerIPAddr; //测试电脑的静态IP地址。


#if  __LWIP__ESP_8266 || __MT7681__ || __STM32F107__ || __STM32F103_UIP__
